      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            OPAS Authority OS™ — the architectural map of the 3-Layer Governance stack in production.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {/* Glassmorphism container — 1px #39FF14 @ 30% border (outer treatment only, does not touch image pixels) */}
          <div
          ...
          >
            {/* Raw high-fidelity image — no filters that wash out the neon bar chart vs 5.4× text */}
            <img
          ...
          {/* Caption strip — right-padded so the badge in the viewport corner never collides with the right text */}
