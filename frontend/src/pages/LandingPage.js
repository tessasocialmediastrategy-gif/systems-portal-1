...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030303] overflow-hidden">
      ...
      {/* Quantum Financial Deployment — Video Showcase */}
      <section className="relative py-20 md:py-28 overflow-hidden" style={{ backgroundColor: '#121212' }}>
        {/* (3) Fixed CSS Grid Pattern — static parallax */}
        <div
          aria-hidden
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative">
              {/* (4) Soft large-radius radial glow behind video — #39FF14 @ 8% */}
              <div
                aria-hidden
              ...
              {/* (1) Glassmorphism container — 1px #39FF14 @ 30% border + edge blur */}
              <div
              ...
              >
                {/* Aspect-ratio cradle for responsive 16:9 */}
                <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                  ...
                  {/* Edge softening — inner vignette blurs the video edges into the glass */}
                  <div
                    aria-hidden
